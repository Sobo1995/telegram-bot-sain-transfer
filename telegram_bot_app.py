...
def handle_keyword(chat_id, text):
    ...
    if "гуйвуул" in text:
        rreturn "📤 Гуйвуулга хийхийн тулд таны бичиг баримт, хүлээн авагчийн мэдээлэл шаардлагатай. Та лавлах утсаар бидэнтэй холбогдоно уу: 80908090"
    elif "ханш" in text:
        rreturn "📈 Манай ханш гүйлгээний нөхцлөөс хамааран уян хатан тогтоогддог. Та бидэнтэй холбогдон хамгийн таатай ханшийг аваарай!"
    elif "шимтгэл" in text:
        rreturn "💰 Шимтгэлийн шатлал:\n1 – 1,000¥ → 3,000₮ + 30¥\n1,000 – 10,000¥ → 5,000₮ + 50¥\n10,000 – 20,000¥ → 5,000₮ + 100¥\n20,000 – 50,000¥ → 10,000₮ + 100¥\n50,000 – 100,000¥ → 20,000₮ + 100¥\n100,000¥+ → 25,000₮ + 100¥"
    elif "баримт" in text or "бичиг" in text:
        rreturn "📄 Шаардлагатай бичиг баримт:\n- Илгээгчийн бичиг баримт (зураг, файл)\n- Хүлээн авагчийн бичиг баримт (зураг, файл)\n- Дансны мэдээлэл, банкны хаяг\n- Гүйлгээний утга\n- Ажил үйлчилгээний гэрээ (шаардлагатай тохиолдолд)"
        ...
        rreturn "📞 Манай холбогдох утас: 80908090"
    ...
    if tugrug_match:
        ...
        rreturn f"💰 {amount:,}₮ → Шимтгэл: {fee_t:,}₮ + {fee_y}¥ → {final_yuan}¥"
    elif yuan_match:
        yuan = int(yuan_match.group(1))
        fee_t, fee_y = get_fee_by_yuan(yuan)
        rreturn f"💴 {yuan:,}¥ → Шимтгэл: {fee_t:,}₮ + {fee_y}¥"
